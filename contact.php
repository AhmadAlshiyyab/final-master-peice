...
if( ( isset($name) && !empty($name) ) && ( isset($email) && !empty($email) ) && ( isset($user_msg) && !empty($user_msg) ) && ( isset($phone) && !empty($phone) ) ) {
	...
	$to = "ahmed.alshiyyab@gmail.com"; //Programmers email
	...
	$header  = "ahmed.alshiyyab@gmail.com";
			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
					...
					<div class="sidebar col_last nobottommargin">
						...
						<abbr title="Phone Number"><strong>Phone:</strong></abbr> +962772270389<br>
						<abbr title="Email Address"><strong>Email:</strong></abbr> ahmed.alshiyyab@gmail.com

					
						<div class="widget noborder notoppadding">

							<a target="_blank" href="https://web.facebook.com/ahmed.alshyyab" class="social-icon si-small si-dark si-facebook">
								<i class="icon-facebook"></i>
								<i class="icon-facebook"></i>
							</a>

							<a target="_blank" href="https://twitter.com/alshyyab1996" class="social-icon si-small si-dark si-twitter">
								<i class="icon-twitter"></i>
								<i class="icon-twitter"></i>
							</a>

							<a target="_blank" href="https://www.instagram.com/ahmedshyyab/" class="social-icon si-small si-dark si-instagram">
								<i class="icon-instagram"></i>
								<i class="icon-instagram"></i>
							</a>

							<a target="_blank" href="https://www.pinterest.com/ahmed1996alshyyab/" class="social-icon si-small si-dark si-pinterest">
								<i class="icon-pinterest"></i>
								<i class="icon-pinterest"></i>
							</a>

							<a target="_blank" href="https://www.linkedin.com/in/ahmad-alshiyyab-b02a65267/" class="social-icon si-small si-dark si-linkedin">
								<i class="icon-linkedin"></i>
								<i class="icon-linkedin"></i>
							</a>

							<a target="_blank" href="https://github.com/AhmadAlshiyyab" class="social-icon si-small si-dark si-github">
